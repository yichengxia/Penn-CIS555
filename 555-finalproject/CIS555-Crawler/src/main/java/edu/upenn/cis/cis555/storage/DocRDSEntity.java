...
/**
 * This is the entity for Amazon RDS.
 */
public class DocRDSEntity {
	...
	public DocRDSEntity(String url, String urlId, String docId, String docBlockName, int docBlockIndex, long lastCrawledTs, long lastModifiedTs) {
		this.url = url;
		this.urlId = urlId;
		this.docId = docId;
